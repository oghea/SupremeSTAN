        ...
        <div class="col-md-12 profile-content">
            ...
            <div class="x_content">
                <div class="col-xs-10 col-xs-offset-1">
                    {!!Form::open(['route' => ['soal.update', $bundleId,$id] , 'role' => 'form','files' => true,'method'=>'POST'])!!}
                    {{--{{ csrf_field() }}--}}
                    ...
                    <div class="col-md-5">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                {!! Form::radio('jawaban', 1,$soal->kunciUsm->jawaban_benar==1) !!}
                                <label>
                                    A
                                </label>
                            </div>
                    ...
                    <div class="col-md-5 col-md-offset-2">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                {!! Form::radio('jawaban', 2,$soal->kunciUsm->jawaban_benar==2) !!}
                                <label>
                                    B
                                </label>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                {!! Form::radio('jawaban', 3,$soal->kunciUsm->jawaban_benar==3) !!}
                                <label>
                                    C
                                </label>
                            </div>
                    ...
                    <div class="col-md-5 col-md-offset-2">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                {!! Form::radio('jawaban', 4,$soal->kunciUsm->jawaban_benar==4) !!}
                                <label>
                                    D
                                </label>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                {!! Form::textarea('pembahasan', $soal->pembahasanUsm->description, array('class ' => 'form-control soal')) !!}
                            </div>
                        </div>
                    </div>
