        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!!Form::open(['action' => 'ManageBundleController@storeBundleTPA' ,'class' => 'form-horizontal form-label-left'])!!}
                            ...
                            <div id="step-1">
                                {{--<form class="form-horizontal form-label-left">--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" readonly="readonly" placeholder="TPA">
                                        </div>
                                    </div>
                                {{--</form>--}}
                            </div>
